ATRIBUTO "Dor no peito"         ( "Fraca", "Forte", "Inexistente" )
ATRIBUTO "Especialidade Médica" ( "Pneumologia", "Cardiologia", "Neurologia" )
ATRIBUTO "Lapsos"               ( "Constantes", "Inexistentes" )
ATRIBUTO "Lembranças"           ( "Vagas", "Detalhadas" )
ATRIBUTO "Memória"              ( "Falha", "Normal" )
ATRIBUTO "Movimentos"           ( "Normais", "Lentos" )
ATRIBUTO "Respiração"           ( "Normal", "Com dor" )
ATRIBUTO "Tosse"                ( "Constante", "Fraca", "Inexistente" )
