...
REGRA "sintomas_sao_graves" (
  SE
    ...
    E  ("outros_sintomas" = "Dor abdominal associada à diarreia, náuseas, vômitos ou queimação"
...
REGRA "sintomas_nao_sao_graves" (
  SE
       "outros_sintomas" = "Nenhum dos sintomas"
    OU ("outros_sintomas" <> "Dor abdominal associada à diarreia, náuseas, vômitos ou queimação"
